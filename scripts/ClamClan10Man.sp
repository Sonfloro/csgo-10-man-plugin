...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_setCaptain", cmd_setCaptain, ADMFLAG_GENERIC);
	RegAdminCmd("sm_clearCaptains", cmd_clearCaptains, ADMFLAG_GENERIC);
...
public Action cmd_setServer(int client, int args)
{
	...
	PrintToChatAll("\x01[\x07ClamClan\x01]  ClamClan official CS:GO 10 Man Server Config executed (version 0.04)");
